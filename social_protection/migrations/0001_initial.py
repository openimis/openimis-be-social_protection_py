    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holder', models.ForeignKey(blank=True, db_column='Holder', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='policyholder.policyholder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ceiling_per_beneficiary', models.DecimalField(blank=True, db_column='BeneficiaryCeiling', decimal_places=2, max_digits=18, null=True)),
                ('schema', models.TextField(blank=True, db_column='Schema', null=True)),
                ('holder', models.ForeignKey(blank=True, db_column='Holder', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='policyholder.policyholder')),
