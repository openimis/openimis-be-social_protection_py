# Generated by Django 3.2.19 on 2023-06-01 09:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='social_protection.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_valid_to', core.fields.DateTimeField(blank=True, db_column='DateValidTo', null=True)),
                ('replacement_uuid', models.UUIDField(db_column='ReplacementUUID', null=True)),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='social_protection.group')),
        ...
        migrations.AddField(
            model_name='group',
            name='individuals',
            field=models.ManyToManyField(through='social_protection.GroupIndividual', to='individual.Individual'),
        ),
        migrations.AddField(
            model_name='group',
            name='user_created',
            field=models.ForeignKey(db_column='UserCreatedUUID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='group_user_created', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='group',
            name='user_updated',
            field=models.ForeignKey(db_column='UserUpdatedUUID', on_delete=django.db.models.deletion.DO_NOTHING, related_name='group_user_updated', to=settings.AUTH_USER_MODEL),
        ),
    ]
